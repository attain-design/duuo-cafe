...
const Location = () => {
  ...
  return <section id="standort" className="relative">
      <div className="relative h-[600px] w-full parallax-bg" 
           style={{backgroundImage: `url('https://images.unsplash.com/photo-1576753092241-37d18f12f898?q=80&w=1927&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`}}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="mb-8 flex items-center justify-center fade-in-up" style={{transitionDelay: '0.2s'}}>
                <MapPin className="mr-2 h-6 w-6 text-cafe-peach" />
                <p className="text-xl">München - Westend</p>
              </div>
              
              <div className="mb-8 rounded-lg bg-white/10 p-6 backdrop-blur-sm fade-in-up" style={{transitionDelay: '0.3s'}}>
              ...
              <div className="mb-4 fade-in-up" style={{transitionDelay: '0.4s'}}>
              ...
              <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center rounded-full bg-cafe-main px-6 py-3 text-white transition-all duration-300 hover:bg-cafe-dark fade-in-up" style={{transitionDelay: '0.5s'}}>
